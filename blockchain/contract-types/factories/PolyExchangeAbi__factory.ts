...
import type {
  PolyExchangeAbi,
  PolyExchangeAbiInterface,
} from "../PolyExchangeAbi";
...
export class PolyExchangeAbi__factory {
  static readonly abi = _abi;
  static createInterface(): PolyExchangeAbiInterface {
    return new utils.Interface(_abi) as PolyExchangeAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PolyExchangeAbi {
    return new Contract(address, _abi, signerOrProvider) as PolyExchangeAbi;
  }
}

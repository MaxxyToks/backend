...
import type { SpokePoolAbi, SpokePoolAbiInterface } from "../SpokePoolAbi";
...
export class SpokePoolAbi__factory {
  static readonly abi = _abi;
  static createInterface(): SpokePoolAbiInterface {
    return new utils.Interface(_abi) as SpokePoolAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SpokePoolAbi {
    return new Contract(address, _abi, signerOrProvider) as SpokePoolAbi;
  }
}

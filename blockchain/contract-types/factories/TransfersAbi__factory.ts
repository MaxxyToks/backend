...
import type { TransfersAbi, TransfersAbiInterface } from "../TransfersAbi";
...
export class TransfersAbi__factory {
  static readonly abi = _abi;
  static createInterface(): TransfersAbiInterface {
    return new utils.Interface(_abi) as TransfersAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TransfersAbi {
    return new Contract(address, _abi, signerOrProvider) as TransfersAbi;
  }
}
